...
shopModule:addBuyableItem({'wand of decay', 'decay', 'wand of plague', 'plague'}, 2188, 5000, 'wand of plague')
shopModule:addBuyableItem({'wand of cosmic energy', 'cosmic energy'}, 2189, 10000, 'wand of cosmic energy')
shopModule:addBuyableItem({'wand of inferno', 'inferno'}, 2187, 15000, 'wand of inferno')

shopModule:addBuyableItem({'snakebite rod', 'snakebite'}, 2182, 500, 'snakebite rod')
shopModule:addBuyableItem({'moonlight rod', 'moonlight'}, 2186, 1000, 'moonlight rod')
shopModule:addBuyableItem({'necrotic rod', 'necrotic', 'volcanic rod', 'volcanic'}, 2185, 5000, 'volcanic rod')
shopModule:addBuyableItem({'terra rod', 'terra', 'quagmire rod', 'quagmire'}, 2181, 10000, 'quagmire rod')
shopModule:addBuyableItem({'hailstorm rod', 'hailstorm', 'tempest rod', 'tempest'}, 2183, 15000, 'tempest rod')
...
shopModule:addSellableItem({'wand of decay', 'decay', 'wand of plague', 'plague'}, 2188, 2500, 'wand of plague')
...
shopModule:addSellableItem({'necrotic rod', 'necrotic', 'volcanic rod', 'volcanic'}, 2185, 2500, 'volcanic rod')
shopModule:addSellableItem({'terra rod', 'terra', 'quagmire rod', 'quagmire'}, 2181, 5000, 'quagmire rod')
shopModule:addSellableItem({'hailstorm rod', 'hailstorm', 'tempest rod', 'tempest'}, 2183, 7500, 'tempest rod')
